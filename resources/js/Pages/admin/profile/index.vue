        ...
        <main class="content">
            ...
            >
                ...
                <div>
                    ...
                    <button
                        class="btn btn-gray-800 d-inline-flex align-items-center dropdown-toggle"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"
                    >
                    ...
                    >
                        ...
                        >
                            <svg
                                class="dropdown-icon text-gray-800 me-2"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                    ...
                    <div class="card card-body border-0 shadow mb-4">
                        ...
                        <form @submit.prevent="submit">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div>
                                        <label for="last_name">Hobby</label>
                                        <input
                                            class="form-control"
                                            v-model="
                                                profile[0]['profile']['hobby']
                                            "
                                            id="last_name"
                                            type="text"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 mb-3">
                                    ...
                                    <p
                                        class="text-danger mt-2"
                                        v-if="errors.address_number"
                                        v-text="errors.address_number"
                                    ></p>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-4 mb-3">
                                    ...
                                    <select
                                        v-model="profile[0]['profile']['state']"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="zip">Professional Job</label>
                                        <input
                                            class="form-control"
                                            id="zip"
                                            type="tel"
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            >
                                <div>
                                    ...
                                    <p class="small pe-4">
                                        Get Rocket news, announcements, and
                                        product updates
                                    </p>
                                </div>
                                <div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="card shadow border-0 text-center p-0">
                                ...
                                <div class="card-body pb-5">
                                    <img
                                        :src="'http://localhost:8000/storage/admin_profile_images/'+profile[0]['profile'].image"
                                        class="avatar-xl rounded-circle mx-auto mt-n7 mb-4"
                                        alt="Neil Portrait"
                                    />
                                    <h4 class="h3">{{ profile[0]['profile'].name }}</h4>
                                    <h5 class="fw-normal">
                                      {{ profile[0]['profile'].job }}
                                    </h5>
                                    <p class="text-gray mb-4">{{ profile[0]['profile'].city }} </p>

                                    <div><button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-form-change-password">Change Password</button></div>
                                </div>
                            </div>
                        </div>
                        <!-- moal content here -->
                        <div class="modal fade" id="modal-form-change-password" tabindex="-1" role="dialog" aria-labelledby="modal-form-signup" aria-hidden="true">
                                                  ...
                                                  <div class="modal-body p-0">
                                                      <div class="card p-3 p-lg-4">
                                                          ...
                                                          <div class="text-center text-md-center mb-4 mt-md-0">
                                                              <h1 class="mb-0 h4">Change Password</h1>
                                                          </div>
                                                          <form action="" class="mt-4" @submit.prevent="submit">
                                                              ...
                                                              <div class="form-group mb-4">
                                                                  ...
                                                                  <div class="input-group">
                                                                      ...
                                                                      placeholder="password" id="email" autofocus required>
                                                                  </div> 
                                                                  <p
                                                  class="text-danger mt-2"
                                                  v-if="errors.old_password"
                                                  v-text="errors.old_password"
                                              ></p> 
                                                              </div>
                                                              <div class="form-group mb-4">
                                                  ...
                                                  v-text="errors.new_password"
                                              ></p> 
                                              <p
                                                  class="text-danger mt-2"
                                                  v-if="errors.password_status"
                                                  v-text="errors.password_status"
                                              ></p> 
                                                              </div>
                                                              <div class="d-grid">
                                                                  <button @click="update()" type="submit" class="btn btn-gray-800">UPDATE</button>
                                                              </div>
                                                          </form>
                                                      </div>
                                                  </div>
                            ...
                            <div class="card card-body border-0 shadow mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="file-field">
                                        <div
                                            class="d-flex justify-content-xl-center ms-xl-3"
                                        >
                                            <div class="d-flex">
                                                <svg
                                                ...
                                                />
                                                <div
                                                    class="d-md-block text-left"
                                                >
                                                    <div
                                                        class="fw-normal text-dark mb-1"
                                                    >
                                                        Choose Image
                                                    </div>
                                                    <div
                                      ...
                                      <p v-if="errors.image" v-text="errors.image" class="text-danger"></p>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    props: { admin: Array, profile: Array, states: Array ,errors:Object},
    ...
    methods: {
        uplaodImage(e) {
            this.profile[0]["profile"].image = e.target.files[0];
        },
        send() {
            this.$inertia.post("/admin/profiles", this.profile[0]["profile"]);
        },
        update()
        {
            this.$inertia.patch("/admin/profiles/change-password",{
