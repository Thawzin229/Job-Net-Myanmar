            ...
            >
                ...
                <div class="btn-toolbar mb-2 mb-md-0 mx-5">
                    <div class="col-lg-12">
                        ...
                        <button
                            type="button"
                            class="btn btn-block btn-gray-800 px-4 mb-3 d-flex align-items-center"
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="border-gray-200">Question</th>
                            <th class="border-gray-200">Answer</th>
                            <th class="border-gray-200">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        <!-- Item -->
                        <tr class="shadow border p-5 " v-for="(faq,index) in faqs.data" :key="index">
                  <td>
                      <a href="#" class="fw-bold">
                          {{ faq.id }}
                      </a>
                  </td>
                  <td><span class="fw-normal">{{ faq.question }}</span></td>                    
                  <td><span class="fw-normal">{{ faq.answer }}</span></td>                    
                  <td>
                      <div class="btn-group">
...
format_list_bulleted
                          ...
                          <div class="dropdown-menu py-0">
                              <Link class="dropdown-item" :href="'/admin/faqs/'+faq.id"><span class="fas fa-edit me-2"></span>Edit</Link>
                              <Link class="dropdown-item text-danger rounded-bottom" :href="'/admin/faqs/'+faq.id" method="DELETE"><span class="fas fa-trash-alt me-2"></span>Remove</Link>
                          </div>
                      </div>
                  </td>
              </tr>   
...
export default {
  props:{admin:Array,errors:Object,faqs:Object},
  ...
  methods:{
        send()
        {
          let faq = {'question':this.question,'answer':this.answer};
          this.$inertia.post('/admin/faqs',faq);
        },
      },
};
</script>
