...
<CampanyDetail :campany="campany" :gallery="gallery"></CampanyDetail>
...
import CampanyDetail from "./detailcom.vue";
import debounce from "lodash/debounce";
export default {
    props: { admin: Array ,errors:Object,campany:Object,gallery:Array},
    data:()=>({
    }),
    watch:{
    ...
    components: { Nav, SideBar, TopNav, footer ,CampanyDetail},
};
</script>
